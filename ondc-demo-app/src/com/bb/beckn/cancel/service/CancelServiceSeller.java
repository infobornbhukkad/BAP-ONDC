...
public class CancelServiceSeller
{
    ...
    public ResponseEntity<String> cancel(final HttpHeaders httpHeaders, final Schema request) throws JsonProcessingException {
        ...
        //CompletableFuture.runAsync(this::lambda$cancel$0);
