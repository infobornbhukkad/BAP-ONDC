...
import com.bb.beckn.search.controller.SearchControllerSeller;

import org.slf4j.Logger;
import org.springframework.web.bind.annotation.RestController;

@RestController
public class InitControllerSeller
{
    private static final Logger log;
    @Autowired
    private InitServiceSeller service;
    @Autowired
    ...
    public ResponseEntity<String> init(@RequestBody final String body, @RequestHeader final HttpHeaders httpHeaders, final HttpServletRequest servletRequest) throws JsonProcessingException {
        ...
        InitControllerSeller.log.info("does buyer {} requires to be authenticated ? {}", (Object)bapId, (Object)authenticate);
        if (authenticate) {
        ...
        return (ResponseEntity<String>)this.service.init(httpHeaders, model);
    }
    ...
    static {
        log = LoggerFactory.getLogger((Class)InitControllerSeller.class);
    }
}
